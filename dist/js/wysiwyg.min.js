...
function _createClass(t, a, i) {
  ...
  var a = function() {
    ...
    return _createClass(a, [{
      ...
      key: "buildTemplate",
      value: function() {
        var t = '\n        <div class="mdb-wysiwyg-container">\n          <div class="mdb-wysiwyg-toolbar">\n            <div class="mdb-wysiwyg-toolbar-group">\n              <div class="mdb-wysiwyg-toolbar-dropdown">\n                <button class="mdb-wysiwyg-toolbar-dropdown-toggle"><span>'.concat(this.options.translations.paragraph, '</span></button>\n                <ul class="mdb-wysiwyg-toolbar-options-list">\n                  <li><a href="#" data-tagname="p">').concat(this.options.translations.paragraph, '</a></li>\n                  <li><a href="#" data-tagname="h1">').concat(this.options.translations.heading, ' 1</a></li>\n                  <li><a href="#" data-tagname="h2">').concat(this.options.translations.heading, ' 2</a></li>\n                  <li><a href="#" data-tagname="h3">').concat(this.options.translations.heading, ' 3</a></li>\n                  <li><a href="#" data-tagname="h4">').concat(this.options.translations.heading, ' 4</a></li>\n                  <li><a href="#" data-tagname="h5">').concat(this.options.translations.heading, ' 5</a></li>\n                  <li><a href="#" data-tagname="h6">').concat(this.options.translations.heading, ' 6</a></li>\n                  <li><a href="#" data-tagname="pre">').concat(this.options.translations.preformatted, '</a></li>\n                </ul>\n              </div>\n            </div>\n            <div class="mdb-wysiwyg-toolbar-group">\n              <ul class="mdb-wysiwyg-toolbar-options">\n                <li><button data-action="bold" data-tooltip data-placement="bottom" title="').concat(this.options.translations.bold, '"><i class="fa fa-bold"></i></button></li>\n                <li><button data-action="italic" data-tooltip data-placement="bottom" title="').concat(this.options.translations.italic, '"><i class="fa fa-italic"></i></button></li>\n                <li><button data-action="strikethrough" data-tooltip data-placement="bottom" title="').concat(this.options.translations.strikethrough, '"><i class="fa fa-strikethrough"></i></button></li>\n                <li><button data-action="underline" data-tooltip data-placement="bottom" title="').concat(this.options.translations.underline, '"><i class="fa fa-underline"></i></button></li>\n                <li>\n                  <button data-tooltip data-placement="bottom" title="').concat(this.options.translations.textcolor, '" class="mdb-wysiwyg-toolbar-dropdown-toggle"><i class="fa fa-font"></i></button>\n                  <ul class="mdb-wysiwyg-toolbar-options-list mdb-wysiwyg-toolbar-color-palette">\n                    ').concat(this.colors, '\n                  </ul>\n                </li>\n              </ul>\n            </div>\n            <div class="mdb-wysiwyg-toolbar-group">\n              <ul class="mdb-wysiwyg-toolbar-options">\n                <li><button data-action="justifyleft" data-tooltip data-placement="bottom" title="').concat(this.options.translations.alignleft, '"><i class="fa fa-align-left"></i></button></li>\n                <li><button data-action="justifycenter" data-tooltip data-placement="bottom" title="').concat(this.options.translations.aligncenter, '"><i class="fa fa-align-center"></i></button></li>\n                <li><button data-action="justifyright" data-tooltip data-placement="bottom" title="').concat(this.options.translations.alignright, '"><i class="fa fa-align-right"></i></button></li>\n                <li><button data-action="justifyfull " data-tooltip data-placement="bottom" title="').concat(this.options.translations.alignjustify, '"><i class="fa fa-align-justify"></i></button></li>\n              </ul>\n            </div>\n            <div class="mdb-wysiwyg-toolbar-group">\n              <ul class="mdb-wysiwyg-toolbar-options">\n                <li><button data-action="insertlink" data-tooltip data-placement="bottom" title="').concat(this.options.translations.insertlink, '"><i class="fa fa-paperclip"></i></button></li>\n                <li><button data-action="insertpicture" data-tooltip data-placement="bottom" title="').concat(this.options.translations.insertpicture, '"><i class="fa fa-picture-o"></i></button></li>\n              </ul>\n            </div>\n            <div class="mdb-wysiwyg-toolbar-group">\n              <ul class="mdb-wysiwyg-toolbar-options">\n                <li><button data-action="insertUnorderedList" data-tooltip data-placement="bottom" title="').concat(this.options.translations.bulletlist, '"><i class="fa fa-list-ul"></i></button></li>\n                <li><button data-action="insertOrderedList" data-tooltip data-placement="bottom" title="').concat(this.options.translations.numberedlist, '"><i class="fa fa-list-ol"></i></button></li>\n              </ul>\n            </div>\n            <div class="mdb-wysiwyg-toolbar-group">\n              <ul class="mdb-wysiwyg-toolbar-options">\n                <li><button data-action="toggleHTML" data-tooltip data-placement="bottom" title="').concat(this.options.translations.showHTML, '"><i class="fa fa-code"></i></button></li>\n              </ul>\n            </div>\n          </div>\n          <div class="mdb-wysiwyg-textarea" contenteditable="true" id="wysiwyg-').concat(this.uuid, '">').concat(this.content, "</div>\n\n        </div>\n      ");
        this.$textarea.css({
          width: 0,
          height: 0,
          visibility: "hidden"
