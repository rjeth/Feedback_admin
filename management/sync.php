<?php
    ...
    while ($row = mysqli_fetch_assoc($sql)) {
        $button = '<a name="edit" ui_id="'.$row['ui_id'].'"><i class="fas fa-edit" data-toggle="tooltip" data-placement="bottom" title="Update"></i></a>&nbsp;<a name="delete" ui_id="'.$row['ui_id'].'"><i class="fas fa-trash-alt" data-toggle="tooltip" data-placement="bottom" title="Delete"></i></a>&nbsp;<a name="delete" ui_id="'.$row['ui_id'].'"><i class="fas fa-info" data-toggle="tooltip" data-placement="bottom" title="Delete"></i></a>';
        $output['data'][] = array(
            $row['fname'],
            $row['mname'],
            $button
